...
peso_soc_bike = [0.0] * num_amostras
peso_soc_est = [0.0] * num_amostras
peso_p_rede = [0.0] * num_amostras
...
for k in dados_entrada.index:
    ...
    # BATERIA BIKE:
    prob += p_ch_bike1[k] == p_max_bat_bike * flag_ch_bat_bike1[k] # If use "<=", can p=0 and flag=1
    ...
    prob += p_dc_bike2[k] == p_max_bat_bike * eff_conv_w * flag_dc_bat_bike2[k]
    prob += flag_ch_bat_bike2[k] + flag_dc_bat_bike2[k] <= 1 # simultaneity
    
    prob += flag_ch_bat_bike1[k] == flag_ch_bat_bike2[k]
    prob += flag_dc_bat_bike1[k] == flag_dc_bat_bike2[k]
...
flag_ch_bat_bike1_res = [0.0] * num_amostras
flag_dc_bat_bike1_res = [0.0] * num_amostras
flag_ch_bat_bike2_res = [0.0] * num_amostras
flag_dc_bat_bike2_res = [0.0] * num_amostras
...
for k in dados_entrada.index:
    ...
    flag_ch_bat_bike1_res[k] = flag_ch_bat_bike1[k].varValue
    flag_dc_bat_bike1_res[k] = flag_dc_bat_bike1[k].varValue
    flag_ch_bat_bike2_res[k] = flag_ch_bat_bike2[k].varValue
    flag_dc_bat_bike2_res[k] = flag_dc_bat_bike2[k].varValue
